...
export const knownTools: KnownTool[] = [
  ...
  { name: "Netflix", website: "netflix.com", category: "Entertainment", aliases: ["netflix streaming"] },
  { name: "YouTube Premium", website: "youtube.com", category: "Entertainment", aliases: ["youtube music", "yt premium"] },
  { name: "Spotify", website: "spotify.com", category: "Entertainment", aliases: ["spotify music"] },
  { name: "Disney+", website: "disneyplus.com", category: "Entertainment", aliases: ["disney plus"] },
  { name: "Amazon Prime Video", website: "primevideo.com", category: "Entertainment", aliases: ["prime video", "amazon video"] },
  { name: "Apple TV+", website: "tv.apple.com", category: "Entertainment", aliases: ["apple tv"] },
  { name: "Hulu", website: "hulu.com", category: "Entertainment", aliases: ["hulu plus"] },
  { name: "HBO Max", website: "max.com", category: "Entertainment", aliases: ["hbo", "max"] },
  { name: "Paramount+", website: "paramountplus.com", category: "Entertainment", aliases: ["paramount plus"] },
  { name: "Peacock", website: "peacocktv.com", category: "Entertainment", aliases: ["peacock tv"] },
  { name: "Twitch", website: "twitch.tv", category: "Entertainment", aliases: ["twitch prime", "twitch tv"] },
  { name: "Crunchyroll", website: "crunchyroll.com", category: "Entertainment", aliases: ["crunchy roll"] },
  { name: "Audible", website: "audible.com", category: "Entertainment", aliases: ["amazon audible"] },

  // Gaming
  { name: "Steam", website: "steampowered.com", category: "Gaming", aliases: ["steam store"] },
  { name: "Xbox Game Pass", website: "xbox.com", category: "Gaming", aliases: ["game pass", "xbox live"] },
  { name: "PlayStation Plus", website: "playstation.com", category: "Gaming", aliases: ["ps plus", "psn"] },
  { name: "Nintendo Switch Online", website: "nintendo.com", category: "Gaming", aliases: ["nintendo online"] },
  { name: "Epic Games", website: "epicgames.com", category: "Gaming", aliases: ["epic store"] },
  { name: "Roblox", website: "roblox.com", category: "Gaming", aliases: ["roblox app"] },
  { name: "Battle.net", website: "battle.net", category: "Gaming", aliases: ["blizzard"] },
  { name: "Ubisoft+", website: "ubisoft.com", category: "Gaming", aliases: ["ubisoft plus"] },
  { name: "EA Play", website: "ea.com/ea-play", category: "Gaming", aliases: ["origin access"] },

  // AI & Machine Learning
  { name: "ChatGPT", website: "openai.com", category: "AI Tools", aliases: ["openai", "chat gpt"] },
  { name: "Claude", website: "anthropic.com", category: "AI Tools", aliases: ["anthropic", "claude ai"] },
  { name: "Gemini", website: "gemini.google.com", category: "AI Tools", aliases: ["google ai", "bard"] },
  { name: "Midjourney", website: "midjourney.com", category: "AI Tools", aliases: ["mj ai"] },
  { name: "Perplexity", website: "perplexity.ai", category: "AI Tools", aliases: ["perplexity ai"] },
  { name: "Jasper", website: "jasper.ai", category: "AI Tools", aliases: ["jasper ai"] },
  { name: "Copy.ai", website: "copy.ai", category: "AI Tools", aliases: ["copy ai"] },
  { name: "Descript", website: "descript.com", category: "AI Tools", aliases: ["descript editing"] },
  { name: "Grammarly", website: "grammarly.com", category: "AI Tools", aliases: ["grammarly editor"] },
  { name: "Quillbot", website: "quillbot.com", category: "AI Tools", aliases: ["quill bot"] },
  { name: "Otter.ai", website: "otter.ai", category: "AI Tools", aliases: ["otter transcription"] },
  { name: "ElevenLabs", website: "elevenlabs.io", category: "AI Tools", aliases: ["eleven labs"] },

  // Infrastructure & Low-Code
  { name: "Supabase", website: "supabase.com", category: "Development", aliases: ["supabase db"] },
  { name: "Firebase", website: "firebase.google.com", category: "Development", aliases: ["google firebase"] },
  { name: "Railway", website: "railway.app", category: "Development", aliases: ["railway app"] },
  { name: "Render", website: "render.com", category: "Development", aliases: ["render cloud"] },
  { name: "Fly.io", website: "fly.io", category: "Development", aliases: ["fly io"] },
  { name: "Hetzner", website: "hetzner.com", category: "DevOps", aliases: ["hetzner cloud"] },
  { name: "Linode", website: "linode.com", category: "DevOps", aliases: ["akamai linode"] },
  { name: "Vultr", website: "vultr.com", category: "DevOps", aliases: ["vultr cloud"] },
  { name: "Bubble", website: "bubble.io", category: "Development", aliases: ["bubble io", "no code"] },
  { name: "Webflow", website: "webflow.com", category: "Design", aliases: ["web flow"] },
  { name: "Zapier", website: "zapier.com", category: "Productivity", aliases: ["zapier automation"] },
  { name: "Make.com", website: "make.com", category: "Productivity", aliases: ["integromat", "make automation"] },

  // Business & Finance
  { name: "Mercury", website: "mercury.com", category: "Finance/Payments", aliases: ["mercury banking"] },
  { name: "Brex", website: "brex.com", category: "Finance/Payments", aliases: ["brex card"] },
  { name: "Ramp", website: "ramp.com", category: "Finance/Payments", aliases: ["ramp card"] },
  { name: "Navan", website: "navan.com", category: "Finance/Payments", aliases: ["tripactions", "navan travel"] },
  { name: "Gusto", website: "gusto.com", category: "Finance/Payments", aliases: ["gusto payroll"] },
  { name: "Deel", website: "deel.com", category: "Finance/Payments", aliases: ["letsdeel"] },
  { name: "Remote", website: "remote.com", category: "Finance/Payments", aliases: ["remote com"] },
  { name: "Revolut Business", website: "revolut.com/business", category: "Finance/Payments", aliases: ["revolut"] },

  // Additional Common SaaS
  { name: "Intercom", website: "intercom.com", category: "CRM/Sales", aliases: ["intercom chat"] },
  { name: "Drift", website: "drift.com", category: "CRM/Sales", aliases: ["drift chat"] },
  { name: "Typeform", website: "typeform.com", category: "Marketing", aliases: ["type form"] },
  { name: "SurveyMonkey", website: "surveymonkey.com", category: "Marketing", aliases: ["survey monkey"] },
  { name: "Mailgun", website: "mailgun.com", category: "Marketing", aliases: ["mail gun"] },
  { name: "SendGrid", website: "sendgrid.com", category: "Marketing", aliases: ["twilio sendgrid"] },
  { name: "Postmark", website: "postmarkapp.com", category: "Marketing", aliases: ["postmark mail"] },
  { name: "Ghost", website: "ghost.org", category: "Productivity", aliases: ["ghost blog"] },
  { name: "Substack", website: "substack.com", category: "Productivity", aliases: ["substack news"] },
  { name: "Medium", website: "medium.com", category: "Productivity", aliases: ["medium membership"] },
  { name: "Patreon", website: "patreon.com", category: "Finance/Payments", aliases: ["patreon creator"] },
  { name: "Gumroad", website: "gumroad.com", category: "Ecommerce", aliases: ["gum road"] },
  { name: "LemonSqueezy", website: "lemonsqueezy.com", category: "Ecommerce", aliases: ["lemon squeezy"] },

  // Lifestyle & Education
  { name: "Duolingo", website: "duolingo.com", category: "Education", aliases: ["duolingo plus"] },
  { name: "Coursera", website: "coursera.org", category: "Education", aliases: ["coursera plus"] },
  { name: "Udemy", website: "udemy.com", category: "Education", aliases: ["udemy courses"] },
  { name: "Skillshare", website: "skillshare.com", category: "Education", aliases: ["skill share"] },
  { name: "MasterClass", website: "masterclass.com", category: "Education", aliases: ["master class"] },
  { name: "LinkedIn Learning", website: "linkedin.com/learning", category: "Education", aliases: ["lynda"] },
  { name: "Headspace", website: "headspace.com", category: "Lifestyle", aliases: ["head space"] },
  { name: "Calm", website: "calm.com", category: "Lifestyle", aliases: ["calm app"] },
