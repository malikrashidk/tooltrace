  ...
  if (!isPaidPlan) {
    return (
      <FeaturePaywall
        ...
        description="Identify tools you're paying for but rarely using. Low usage alerts and detailed savings opportunities are available on Pro and Enterprise plans."
        requiredPlan="pro"
